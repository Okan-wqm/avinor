"""
Base settings for Aircraft Service.
"""
import os
import sys
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'aircraft_service_db'),
        'USER': os.environ.get('DB_USER', 'aircraft_service_user'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'aircraft_service_password'),
