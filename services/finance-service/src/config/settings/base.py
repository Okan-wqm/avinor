# services/finance-service/src/config/settings/base.py
"""
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for billing, payments, and financial reports',
...
SERVICE_URLS = {
    ...
    'finance-service': os.environ.get('CERTIFICATE_SERVICE_URL', 'http://finance-service:8010'),
