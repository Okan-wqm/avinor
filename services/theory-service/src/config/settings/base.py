# services/theory-service/src/config/settings/base.py
"""
Base settings for Theory Service
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'theory_service_db'),
        'USER': os.environ.get('DB_USER', 'theory_service'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'theory_service_password'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Theory Service API',
    'DESCRIPTION': 'API for ground school, exams, and course materials',
