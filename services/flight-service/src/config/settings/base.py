"""Base settings for Flight Service."""
import os
import sys
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'flight_service_db'),
        'USER': os.environ.get('DB_USER', 'flight_service_user'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'flight_service_password'),
...
CACHES = {'default': {'BACKEND': 'django_redis.cache.RedisCache', 'LOCATION': os.environ.get('REDIS_URL', 'redis://redis:6379/5')}}
