# services/report-service/src/config/settings/base.py
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'report_service_db'),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for analytics, reporting, and dashboards',
...
SERVICE_URLS = {
    ...
    'report-service': os.environ.get('CERTIFICATE_SERVICE_URL', 'http://report-service:8012'),
