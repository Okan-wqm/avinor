# services/user-service/src/config/settings/base.py
"""
Base settings for User Service
"""
...
if os.environ.get('DB_REPLICA_HOST'):
    ...
    DATABASE_ROUTERS = ['common.db_routers.ReadReplicaRouter']
...
REDIS_CLUSTER_NODES = os.environ.get('REDIS_CLUSTER_NODES', 'localhost:7000').split(',')
...
CACHES = {
    ...
    'session': {
        ...
        'KEY_PREFIX': f'{SERVICE_NAME}:session',
        'TIMEOUT': 86400,
    },
}
...
CELERY_TASK_ROUTES = {
    'apps.core.tasks.high_priority.*': {'queue': 'high_priority'},
    'apps.core.tasks.low_priority.*': {'queue': 'low_priority'},
...
SERVICE_URLS = {
    ...
    'certificate-service': os.environ.get('CERTIFICATE_SERVICE_URL', 'http://certificate-service:8009'),
...
EMAIL_VERIFICATION_TOKEN_EXPIRY = 48
