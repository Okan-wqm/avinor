# services/certificate-service/src/config/settings/base.py
"""
...
SERVICE_PORT = int(os.environ.get('SERVICE_PORT', 8009))
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'certificate_service_db'),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for licenses, ratings, and medical certificates',
